...
#ifdef CONFIG_ANCORA_DEFAULTMEM
#define MSM_PMEM_SF_SIZE		0x1A00000
#elif CONFIG_ANCORA_KEFF
#define MSM_PMEM_SF_SIZE		0x000DA1A
#endif
...
#elif CONFIG_ANCORA_KEFF
#define MSM_PMEM_ADSP_SIZE		0X2D90000
#define MSM_FLUID_PMEM_ADSP_SIZE	0x2900000
#endif
...
static int oliver_tsp_ldo_on(void)
{
	...
	rc = vreg_set_level(vreg_ldo2, 1600);
	if (rc) {
...
static struct mmc_platform_data msm7x30_sdc1_data = {
	.ocr_mask  	= MMC_VDD_165_195 | MMC_VDD_25_26 | MMC_VDD_26_27,
...
#else
static struct mmc_platform_data msm7x30_sdc1_data = {
	.ocr_mask  	= MMC_VDD_165_195 | MMC_VDD_21_22 | MMC_VDD_22_23,
...
static struct mmc_platform_data msm7x30_sdc2_data = {
	.ocr_mask	= MMC_VDD_165_195 | MMC_VDD_25_26,
	.translate_vdd	= msm_sdcc_setup_power,
#ifdef CONFIG_MMC_MSM_SDC2_8_BIT_SUPPORT
