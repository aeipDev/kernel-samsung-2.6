...
static struct pll pll2_tbl[] = {
	{  42, 0, 1, 0 }, /*  806 MHz */
	{  47, 1, 3, 0 }, /*  902 MHz NEW*/
	{  53, 1, 3, 0 }, /* 1024 MHz */
	{  58, 1, 3, 0 }, /* 1113 MHz NEW*/
	{  63, 1, 3, 0 }, /* 1209 MHz */
	{  68, 1, 3, 0 }, /* 1305 MHz NEW*/
	{  73, 0, 1, 0 }, /* 1401 MHz */
...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	{ 0, 24576,  SRC_LPXO, 0, 0,  30720000,  775, VDD_RAW(775) },
	{ 0, 61440,  PLL_3,    5, 11, 61440000,  775, VDD_RAW(775) },
	{ 1, 122880, PLL_3,    5, 5,  61440000,  775, VDD_RAW(775) },
	{ 0, 184320, PLL_3,    5, 4,  61440000,  775, VDD_RAW(775) },
	{ 0, MAX_AXI_KHZ, SRC_AXI, 1, 0, 61440000, 775, VDD_RAW(775) },
	{ 1, 245760, PLL_3,    5, 2,  61440000,  775, VDD_RAW(775) },
	...
	{ 1, 902400,  PLL_2, 3, 0, UINT_MAX, 1000, VDD_RAW(1000), &pll2_tbl[1]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1025, VDD_RAW(1025), &pll2_tbl[2]},
	{ 1, 1113600, PLL_2, 3, 0, UINT_MAX, 1050, VDD_RAW(1050), &pll2_tbl[3]},
	{ 1, 1209600, PLL_2, 3, 0, UINT_MAX, 1075, VDD_RAW(1075), &pll2_tbl[4]},
	{ 1, 1305600, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), &pll2_tbl[5]},
	{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1125, VDD_RAW(1125), &pll2_tbl[6]},
#ifdef CONFIG_MSM_CPU_FREQ_OVERCLOCKING
	{ 1, 1516800, PLL_2, 3, 0, UINT_MAX, 1175, VDD_RAW(1175), &pll2_tbl[7]},
	{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1225, VDD_RAW(1225), &pll2_tbl[8]},
...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 902400,  PLL_2, 3, 0, UINT_MAX, 1150, VDD_RAW(1150), &pll2_tbl[1]},
